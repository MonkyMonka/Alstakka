...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<ThrownDipEntity>> THROWNDIP =
            ENTITY_TYPES.register("thrown_dip",
                    () -> EntityType.Builder.<ThrownDipEntity>of(ThrownDipEntity::new, MobCategory.MISC.MISC)
                            .sized(0.25f, 0.25f)
